    ...
    <>
      <div className="services py-10 ">
        <div className="px-5 sm:px-8 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center items-center mt-10 w-11/12 text-center mx-auto">
            <div className="block rounded-lg shadow-secondary-1 dark:bg-surface-dark dark:text-white text-surface w-full sm:w-1/2 lg:w-1/2 p-2">
              <Link to="/case-packer">
