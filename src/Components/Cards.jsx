...
export default function Cards({language}) {
    return (
        <>
        <div className="my-5 mx-auto max-w-xs text-center">
            ...
            <div className=" grid grid-cols-1 gap-x-5 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-5 pb-4 bg-gray-400 ">
                
                <div
                    className="mx-3 mt-6 cards  flex flex-col bg-white rounded-lg text-surface shadow-secondary-1 dark:bg-surface-dark dark:text-gray-500 sm:shrink-0 sm:grow sm:basis-0 animate-fade-down animate-once">
                    ...
                    <div className="p-6 item">
                        ...
                        <button
                            type="button"
                            className="inline-block hvr-pulse rounded bg-SecondColor px-6 pb-2 pt-2.5 text-xs font-bold uppercase leading-normal text-white shadow-primary-3 transition duration-150 ease-in-out hover:bg-primary-accent-300 hover:shadow-primary-2 focus:bg-primary-accent-300 focus:shadow-primary-2 focus:outline-none focus:ring-0 active:bg-primary-600 active:shadow-primary-2 dark:shadow-black/30 dark:hover:shadow-dark-strong dark:focus:shadow-dark-strong dark:active:shadow-dark-strong"
