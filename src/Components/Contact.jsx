...
const Contact = ({ language, setLanguage }) => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.sendForm("service_vfjt0xw", "template_oc2xozk", e.target).then(
      () => {
        setMsg("Email Sent");
        setFormState({
          name: "",
  ...
  return (
    <>
      ...
      <section className="contact py-10">
        ...
        <div
          className="relative flex items-top mt-0 justify-center min-h-screen  sm:items-center sm:pt-0 w-11/12 m-auto"
          data-aos="zoom-in"
        >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20">
                <div className="p-6 contact-text mr-2 bg-gray-100 dark:bg-white rounded-lg">
                  ...
                  <div className="contact_item">
                    <p className="mt-2 text-2xl text-SecondColor">
                      {language === "AR"
                        ? ` تركيا `
                        : language === "EN"
                        ? `Türkiye`
                ...
                >
                  <div>
                    ...
                    <input
                      ...
                      className="shadow-sm navbar border border-gray-300 text-black text-sm rounded-lg focus:ring-SecondColor-500 focus:border-SecondColor-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-SecondColor-500 dark:focus:border-SecondColor-500 dark:shadow-sm-light"
                      required
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className="shadow-sm navbar border border-gray-300 text-white text-sm rounded-lg focus:ring-SecondColor-500 focus:border-SecondColor-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-SecondColor-500 dark:focus:border-SecondColor-500 dark:shadow-sm-light"
                      placeholder={
                        language === "AR"
                          ? ` name@gmail.com `
                          : language === "EN"
                  ...
                  <div className="sm:col-span-2">
                    ...
                    <textarea
                      ...
                      required
                      onChange={handleChange}
                      className="block navbar p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg shadow-sm border border-gray-300 focus:ring-SecondColor-500 focus:border-SecondColor-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-SecondColor-500 dark:focus:border-SecondColor-500"
                      placeholder={
                        language === "AR"
                          ? `اترك تعليقك....`
                          : language === "EN"
                  ...
                  <button
                    type="submit"
                    className="btn-form py-3 hvr-grow px-5 text-sm  bg-SecondColor font-medium text-center text-white rounded-lg  sm:w-fit  focus:ring-4 focus:outline-none focus:ring-SecondColor-300  dark:focus:ring-SecondColor-800"
                  >
                    {language === "AR"
                      ? `ارسال`
                      : language === "EN"
